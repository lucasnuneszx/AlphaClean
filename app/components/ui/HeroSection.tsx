...
const STATS = [
  { value: "4.200+", label: "Lavagens Realizadas", sub: "Brilho técnico" },
  { value: "100%", label: "Padrão Laboratório", sub: "Manual e cuidadoso" },
  { value: "4.9/5", label: "Avaliação Google", sub: "Média de +500 clientes" },
  { value: "+6 anos", label: "Experiência", sub: "Alpha Clean Studio" },
];
      ...
      <div className="container-custom relative z-10 mx-auto w-full">
        <motion.div style={{ opacity: opacityText }}>
            ...
            <div className="max-w-4xl mb-12">
               ...
               >
                 Técnica avançada, insumos de ponta e o rigor laboratorial que seu veículo exige.
               </motion.p>
            </div>
